...
class SelectionTest extends PHPUnit_Framework_TestCase
{
     ...
     * @group fieldType
     * @group selection
     * @covers SelectionConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group selection
     * @covers SelectionConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group selection
     * @covers SelectionConverter::toStorageFieldDefinition
     */
...
EOT;
     ...
     * @group fieldType
     * @group selection
     * @covers SelectionConverter::toFieldDefinition
     */
