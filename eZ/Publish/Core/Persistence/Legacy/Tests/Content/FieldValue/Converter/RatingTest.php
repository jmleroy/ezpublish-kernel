...
class RatingTest extends PHPUnit_Framework_TestCase
{
     ...
     * @group fieldType
     * @group rating
     * @covers RatingConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group rating
     * @covers RatingConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group rating
     * @covers RatingConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group rating
     * @covers RatingConverter::toFieldDefinition
     */
