...
EOT;
     ...
     * @group fieldType
     * @group textBlock
     * @covers TextBlockConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group textBlock
     * @covers TextBlockConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group textBlock
     * @covers TextBlockConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group textBlock
     * @covers TextBlockConverter::toFieldDefinition
     */
