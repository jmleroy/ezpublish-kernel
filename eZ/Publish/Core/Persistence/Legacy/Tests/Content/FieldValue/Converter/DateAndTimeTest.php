...
class DateAndTimeTest extends PHPUnit_Framework_TestCase
{
     ...
     * @group fieldType
     * @group dateTime
     * @covers DateAndTimeConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group dateTime
     * @covers DateAndTimeConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group dateTime
     * @covers DateAndTimeConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group dateTime
     * @covers DateAndTimeConverter::toFieldDefinition
     */
...
EOT;
     ...
     * @group fieldType
     * @group dateTime
     * @covers DateAndTimeConverter::getDateIntervalFromXML
     */
     ...
     * @group fieldType
     * @group dateTime
     * @covers DateAndTimeConverter::generateDateIntervalXML
     */
