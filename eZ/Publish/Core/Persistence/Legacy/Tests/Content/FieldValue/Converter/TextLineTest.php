...
class TextLineTest extends PHPUnit_Framework_TestCase
{
     ...
     * @group fieldType
     * @group textLine
     * @covers TextLineConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group textLine
     * @covers TextLineConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group textLine
     * @covers TextLineConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group textLine
     * @covers TextLineConverter::toFieldDefinition
     */
