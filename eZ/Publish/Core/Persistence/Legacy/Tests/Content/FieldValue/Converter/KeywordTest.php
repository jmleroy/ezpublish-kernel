...
class KeywordTest extends PHPUnit_Framework_TestCase
{
     ...
     * @group fieldType
     * @group keyword
     * @covers KeywordConverter::toStorageValue
     */
     ...
     * @group fieldType
     * @group keyword
     * @covers KeywordConverter::toFieldValue
     */
     ...
     * @group fieldType
     * @group keyword
     * @covers KeywordConverter::toStorageFieldDefinition
     */
     ...
     * @group fieldType
     * @group keyword
     * @covers KeywordConverter::toFieldDefinition
     */
